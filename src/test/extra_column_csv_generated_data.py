...
file_location = "C:\\Users\\Rupali\\PycharmProjects\\youtube_de_project1\\sample_date\\sales_data_to_s3"
...
csv_file_path = os.path.join(file_location, f"extra_columns_{input_date_str}.csv")
